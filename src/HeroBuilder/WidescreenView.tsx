...
import { PreviewWidescreen } from "./PreviewWebsite/PreviewWidescreen";
...
export const WidescreenView = (props: IWidescreenViewProps) => {
  ...
  return (
    <Container
      fluid
      className="mt-5 bg-black my-3 p-2 border border-2 border-secondary rounded"
      style={{ height: "350px" }}>
      <div className="d-flex mb-1">
        ...
        <p
          ...
          {heroBuilderForm.basicInformation.restaurantName.length > 0
            ? heroBuilderForm.basicInformation.restaurantName.toLowerCase().replace(/\s/g, "-")
            : "double-r-diner"}
          .com
        </p>
        <MdClose />
